...
export const metadata: Metadata = { title: "Contact Us — Bright Horizons Academy" };
      ...
      <main className="pt-16">
        <div className="max-w-7xl mx-auto px-5 lg:px-10 py-14" style={{ borderBottom: "1px solid var(--border)" }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="mono-tag">Talk to Us</span>
          </div>
          ...
          <p className="text-xl max-w-2xl leading-relaxed" style={{ color: "var(--fg-2)" }}>
            Have questions? Call us, visit us or send a message — we are always happy to help.
          </p>
        </div>
        <Contact />
      </main>
