...
export const metadata: Metadata = { title: "Our Teachers — Bright Horizons Academy" };
      ...
      <main className="pt-16">
        <div className="max-w-7xl mx-auto px-5 lg:px-10 py-14" style={{ borderBottom: "1px solid var(--border)" }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="mono-tag">Our Teachers</span>
          </div>
          ...
          <p className="text-xl max-w-2xl leading-relaxed" style={{ color: "var(--fg-2)" }}>
            Trained, caring and dedicated — our teachers give their best every single day.
          </p>
        </div>
        <Faculty />
      </main>
