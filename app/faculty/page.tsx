...
export const metadata: Metadata = { title: "Faculty — Bright Horizons Academy" };
      ...
      <main className="pt-16">
        <div className="max-w-7xl mx-auto px-5 lg:px-10 py-16">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="mono-tag">Our Educators</span>
          </div>
          ...
          <p className="text-xl max-w-2xl leading-relaxed" style={{ color: "var(--fg-2)" }}>
            World-class minds who inspire every single day.
          </p>
        </div>
        <Faculty />
      </main>
